...
Ambos proyectos comparten el mismo entorno tecnológico y pueden ejecutarse por separado dentro del mismo [repositorio]([https://codesandbox.io/p/github/panchomalilloss/EjemplosAnimaciones/main?import=true&workspaceId=ws_5w3rada782BwFQctpKAfdG](https://codesandbox.io/p/sandbox/ejemplosanimaciones-dkhg5z)).
